...
/**
 * Servicio que maneja la lógica de negocio relacionada con las listas de usuarios.
 * 
 * Proporciona métodos para crear, actualizar, eliminar y obtener listas de usuarios.
 */
@Service
